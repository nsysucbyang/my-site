        ...
        if (PopUpMenu2_linkArraytmp[i]) 
        {
            ...
            else 
            {
                ...
                { 
                    ...
                    {
                        PopUpMenu2_linkArrayConstr = '<a href="' + 
                                     PopUpMenu2_linkArrayValue.substring(5, PopUpMenu2_linkArrayValue.length) + 
                                     '"  CLASS="popmenu"  onClick="javascript:PopUpMenu2_Stop(true);"  ' + 
                                     PopUpMenu2_OnMouseOver_link + ' ' + PopUpMenu2_OnMouseOut_link + 
                                     ' style="color:' + PopUpMenu2_default_config_tmp[PopUpMenu2_ItemColor_index][1] + 
                                     '; font-family:' + PopUpMenu2_default_config_tmp[PopUpMenu2_ItemFont_index][1] + 
                                     '; font-size: ' + PopUpMenu2_default_config_tmp[PopUpMenu2_ItemSize_index][1] + 
                                     ';">' + PopUpMenu2_linkArrayKey + '</a>';
/*
                    }
                    else 
                    if (PopUpMenu2_linkArrayValue.indexOf("javascript:") != -1) 
                    {
					    PopUpMenu2_linkArrayConstr = '<a href="' + 
                                    PopUpMenu2_linkArrayValue + 
                                    '"  CLASS="popmenu" '+
                                    ' style="color:' + PopUpMenu2_default_config_tmp[PopUpMenu2_ItemColor_index][1] + 
                                    '; font-family:' + PopUpMenu2_default_config_tmp[PopUpMenu2_ItemFont_index][1] + 
                                    '; font-size: ' + PopUpMenu2_default_config_tmp[PopUpMenu2_ItemSize_index][1] + 
                    ...
                    if (PopUpMenu2_linkArrayValue.indexOf(".location=") == -1) 
                    {
